...
.spatial = .spatial file associated with each granule science file to define: BR, Point, or data coordinates parsed from a science file (to be encompassed by a detailed GPoly generated by MetGenC)
```
