...
![security scan workflow](https://github.com/nsidc/granule-metgen/actions/workflows/osv-scanner-scheduled.yml/badge.svg)
...
End_time: 13:21:55
```
or having extra characters in the premet, such as the "~" below the last line
```
Begin_date=2008-06-03
Begin_time=00:00:00
End_date=2008-06-30
End_time=23:59:59
~
```
Also, if the Begin and End dates and times are interleaved that's not an accepted format and will throw this error in the log. For example
```
...
```
will throw an error and needs to be rejigged to
```
Begin_date=2023-04-18
Begin_time=00:00:00.000
End_date=2023-04-18
