    ...
    def test_extract_data_urls(self):
        ...
        umm_json = {
            "RelatedUrls": [
                ...
                {
                    "URL": "https://example.com/data/file2.h5",
                    "Type": "GET DATA"
                }
            ]
        }
...
class TestPolygonComparator:
        ...
        return {
            ...
            "features": [{
                ...
                "geometry": {
                    "type": "Polygon",
                    "coordinates": [[
                        [-120.1, 34.9], [-118.9, 34.9], [-118.9, 36.1], 
                        [-120.1, 36.1], [-120.1, 34.9]
                    ]]
                },
    ...
    def test_compare_polygons(self, cmr_polygon, generated_polygon):
        ...
        expected_metrics = [
            'iou', 'area_ratio', 'cmr_area_deg2', 'generated_area_deg2',
            'cmr_vertices', 'generated_vertices', 'cmr_covered_by_generated',
        ...
        assert metrics['cmr_vertices'] == 4  # Rectangle has 4 vertices (closing point not counted)
