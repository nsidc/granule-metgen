...
class TestGenericScienceReader:
    ...
    def test_parse_metadata_not_implemented(self, test_config, temporal_content, spatial_content):
    ...
    def test_parse_metadata_requires_temporal_override(self, test_config, spatial_content):
    ...
    def test_parse_metadata_requires_spatial_override(self, test_config, temporal_content):
...
class TestExtractMetadata:
    ...
    def test_extract_metadata_not_implemented(self, test_config, temporal_content, spatial_content):
    ...
    def test_returns_auxiliary_data_unchanged(self, test_config, temporal_content, spatial_content):
    ...
    def test_handles_various_file_types(self, test_config, temporal_content, spatial_content):
