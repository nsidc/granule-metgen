...
class TestScienceMetadata:
    ...
    def test_has_required_fields(self):
        ...
        metadata = ScienceMetadata(temporal=temporal, geometry=geometry)
    ...
    def test_optional_fields_default_to_none(self):
        ...
        metadata = ScienceMetadata(temporal=[], geometry=[])
...
class TestBaseScienceReader:
    ...
    def test_read_science_data_calls_subclass_methods(self):
        ...
        class TestReader(BaseScienceReader):
            ...
            def parse_metadata(
                self, raw_data, configuration, gsr, temporal_override, spatial_override
            ):
        ...
        result = reader.read_science_data("/test/file.nc", config, "GEODETIC")
...
class TestCreateExtractMetadataAdapter:
    ...
    def test_adapter_passes_overrides_correctly(self):
        ...
        result = extract_metadata(
            "/test/file.nc", temporal_override, spatial_override, config, "GEODETIC"
        )
    ...
    def test_adapter_excludes_none_production_date(self):
        ...
        class TestReader(BaseScienceReader):
            ...
            def parse_metadata(
                ...
                return ScienceMetadata(
                    temporal=[], geometry=[], production_date_time=None
                )
