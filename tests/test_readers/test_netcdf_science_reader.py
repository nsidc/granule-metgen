...
class TestExtractMetadata:
    ...
    def test_uses_temporal_override_when_provided(self, test_config):
        ...
        with pytest.raises(NotImplementedError):
            extract_metadata(
                "/test/file.nc", temporal_override, [], test_config, "GEODETIC"
            )
