...
def ummc_valid_temporal_extent():
    ...
    return {
        "TemporalExtents": [
            {
                "RangeDateTimes": [{"BeginningDateTime": "2021-11-01T00:00:00.000Z", 
...
def ummc_multi_temporal_extent():
    ...
    return {
        "TemporalExtents": [
            ...
            {
                "RangeDateTimes": [{"BeginningDateTime": "2022-12-01T00:00:00.000Z",
...
class TestCollectionMetadata:
    ...
    def test_can_set_all_fields(self):
        ...
        assert metadata.temporal_extent == [{"start": "2021-01-01", "end": "2021-12-31"}]
        assert metadata.temporal_extent_error is None
